...
@Component({
  selector: 'app-edit-commentaire-bilan-periodique-debut-de-stage',
  templateUrl: './edit-commentaire-bilan-periodique-debut-de-stage.component.html',
  styleUrls: ['./edit-commentaire-bilan-periodique-debut-de-stage.component.css']
})
export class EditCommentaireBilanPeriodiqueDebutDeStageComponent implements OnInit {
  ...
  onSubmit(){
    this.commentaireService.editCommentaireBilan_periodique_debut_du_stageToRemote(this.commentaire).subscribe(
      data => {
        ...
        this.router.navigate(['depotBilan_periodique_debut_du_stage']);
      },
      err => {
        console.log("Error") 
      }
