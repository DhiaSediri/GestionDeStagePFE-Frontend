...
@Component({
  selector: 'app-edit-commentaire-journal-de-stage',
  templateUrl: './edit-commentaire-journal-de-stage.component.html',
  styleUrls: ['./edit-commentaire-journal-de-stage.component.css']
})
export class EditCommentaireJournalDeStageComponent implements OnInit {
  ...
  onSubmit(){
    this.commentaireService.editCommentaireJournal_de_stageToRemote(this.commentaire).subscribe(
      data => {
        ...
        this.router.navigate(['depotJournal_de_stage']);
      },
      err => {
        console.log("Error") 
      }
