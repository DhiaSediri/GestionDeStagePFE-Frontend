...
@Component({
  selector: 'app-edit-commentaire-bilan-periodique-fin-de-stage',
  templateUrl: './edit-commentaire-bilan-periodique-fin-de-stage.component.html',
  styleUrls: ['./edit-commentaire-bilan-periodique-fin-de-stage.component.css']
})
export class EditCommentaireBilanPeriodiqueFinDeStageComponent implements OnInit {
  ...
  onSubmit(){
    this.commentaireService.editCommentaireBilan_periodique_fin_du_stageToRemote(this.commentaire).subscribe(
      data => {
        ...
        this.router.navigate(['depotBilan_periodique_fin_du_stage']);
      },
      err => {
        console.log("Error") 
      }
