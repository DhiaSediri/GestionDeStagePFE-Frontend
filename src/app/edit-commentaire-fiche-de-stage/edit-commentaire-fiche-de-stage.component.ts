...
@Component({
  selector: 'app-edit-commentaire-fiche-de-stage',
  templateUrl: './edit-commentaire-fiche-de-stage.component.html',
  styleUrls: ['./edit-commentaire-fiche-de-stage.component.css']
})
export class EditCommentaireFicheDeStageComponent implements OnInit {
  ...
  onSubmit(){
    this.commentaireService.editCommentaireFiche_de_stageToRemote(this.commentaire).subscribe(
      data => {
        ...
        this.router.navigate(['depotFiche_de_stage']);
      },
      err => {
        console.log("Error") 
      }
